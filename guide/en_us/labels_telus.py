...
class TelusGuideLabels(GuideLabels):
    ...
    LBL_NON_EPISODIC_STRIP_ORDER = [LBL_WATCH_NOW, LBL_RECOVER_STRIP, LBL_BOOKMARK_OPTIONS,
                                    LBL_RECORDING_AND_BOOKMARK_OPTIONS, LBL_CAST, LBL_MAY_ALSO_LIKE, LBL_UPCOMING_AIRINGS]
    LBL_EPISODIC_STRIP_ORDER = [LBL_WATCH_NOW, LBL_ONEPASS_OPTIONS, LBL_ONEPASS_AND_RECORDING_OPTIONS, LBL_CAST,
                                LBL_MAY_ALSO_LIKE, LBL_ALL_EPISODES, LBL_UPCOMING, LBL_UPCOMING_AIRINGS,
                                LBL_ALL_UPCOMING_EPISODES]
