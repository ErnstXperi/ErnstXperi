...
class CC03GuideLabels(GuideLabels):
    ...
    LBL_NON_EPISODIC_STRIP_ORDER = [LBL_WATCH_NOW, LBL_RECOVER_STRIP, LBL_BOOKMARK_OPTIONS,
                                    LBL_RECORDING_AND_BOOKMARK_OPTIONS, LBL_ONEPASS_AND_RECORDING_OPTIONS,
                                    LBL_CAST, LBL_MAY_ALSO_LIKE, LBL_RENT_OPTIONS, LBL_UPCOMING_AIRINGS]
